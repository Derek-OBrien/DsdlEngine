...
namespace DsdlEngine {
	...
	*/
	...
	public:
		...
		*	@param r as SDL_Renderer argument.
		*	@return bool.
		*/
		...
		*	@param scale as a float argument
		*/
		...
		*	@param path as a std::string argument.
		*/
		...
		*	@param type as a NodeType argument.
		*/
		...
		*	@param opacity as an int argument between 0 - 255
		*/
		...
		*	@param text as a std::string argument.
		*/
		...
		*	@param pos as a Vec2 argument.
		*	@param size as a Vec2 argument.
		*/
		...
		*	@param value as a bool argument.
		*/
